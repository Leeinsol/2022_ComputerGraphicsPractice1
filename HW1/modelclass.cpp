...
bool ModelClass::Hexagon(ID3D11Device* device)
{
	bool result;


	// Initialize the vertex and index buffers.
	result = HexagonBuffers(device);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::Pentagon(ID3D11Device* device)
{
	bool result;


	// Initialize the vertex and index buffers.
	result = PentagonBuffers(device);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::Heptagon(ID3D11Device* device)
{
	bool result;


	// Initialize the vertex and index buffers.
	result = HeptagonBuffers(device);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::HexagonBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	...
	vertices[0].position = XMFLOAT3(-1.5f, 0.0f, 0.0f);
	...
	vertices[5].position = XMFLOAT3(1.5f, 0.0f, 0.0f);
...
bool ModelClass::PentagonBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	unsigned long* indices;
	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
	...
	vertices[2].position = XMFLOAT3(-0.5f, -1.0f, 0.0f); 
	vertices[2].color = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);

	vertices[3].position = XMFLOAT3(1.5f, 0.0f, 0.0f);  
	vertices[3].color = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);

	vertices[4].position = XMFLOAT3(0.5f, -1.0f, 0.0f);  
...
bool ModelClass::HeptagonBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	unsigned long* indices;
	D3D11_BUFFER_DESC vertexBufferDesc, indexBufferDesc;
	...
	vertices[3].position = XMFLOAT3(0.0f, 1.5f, 0.0f);
	...
	vertices[6].position = XMFLOAT3(1.5f, 0.0f, 0.0f);
