...
bool ModelClass::Ground(ID3D11Device* device, const WCHAR* textureFilename)
{
	bool result;
...
bool ModelClass::GroundBuffers(ID3D11Device* device)
{
	...
	vertices[0].position = XMFLOAT3(-10.0f, 10.0f, 5.0f);
	vertices[0].texture = XMFLOAT2(0.0f, 0.0f);

	vertices[1].position = XMFLOAT3(10.0f, 10.0f, 5.0f);
	vertices[1].texture = XMFLOAT2(1.0f, 0.0f);

	vertices[2].position = XMFLOAT3(-10.0f, -10.0f, 5.0f);
	vertices[2].texture = XMFLOAT2(0.0f, 1.0f);



	vertices[3].position = XMFLOAT3(-10.0f, -10.0f, 5.0f);
	vertices[3].texture = XMFLOAT2(0.0f, 1.0f);

	vertices[4].position = XMFLOAT3(10.0f, 10.0f, 5.0f);
	vertices[4].texture = XMFLOAT2(1.0f, 0.0f);

	vertices[5].position = XMFLOAT3(10.0f, -10.0f, 5.0f);
