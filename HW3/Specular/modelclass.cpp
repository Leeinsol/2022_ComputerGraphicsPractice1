...
bool ModelClass::Ground(ID3D11Device* device, const WCHAR* modelFilename, const WCHAR* textureFilename)
{
	bool result;
...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	instances[0].position = XMFLOAT3(-200.5f, 0.0f, 0.0f);
	instances[1].position = XMFLOAT3(-200.5f, 0.0f, 400.0f);
	instances[2].position = XMFLOAT3(-200.5f, 0.0f, 800.0f);
	instances[3].position = XMFLOAT3(-200.5f, 0.0f, 1200.0f);
	instances[4].position = XMFLOAT3(-200.5f, 0.0f, 1600.0f);

	instances[5].position = XMFLOAT3(200.5f, 0.0f, 0.0f);
	instances[6].position = XMFLOAT3(200.5f, 0.0f, 400.0f);
	instances[7].position = XMFLOAT3(200.5f, 0.0f, 800.0f);
	instances[8].position = XMFLOAT3(200.5f, 0.0f, 1200.0f);
	instances[9].position = XMFLOAT3(200.5f, 0.0f, 1600.0f);
...
bool ModelClass::GroundBuffers(ID3D11Device* device)
{
	VertexType* vertices;
	unsigned long* indices;
	InstanceType* instances;
	...
	// Load the instance array with data.
	instances[0].position = XMFLOAT3(-50.5f, -50.5f, 0.0f);
